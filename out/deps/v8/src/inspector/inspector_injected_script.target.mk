...
quiet_cmd__home_dsw________node_deps_v8_src_inspector_inspector_gyp_inspector_injected_script_target_convert_js_to_cpp_char_array = ACTION _home_dsw________node_deps_v8_src_inspector_inspector_gyp_inspector_injected_script_target_convert_js_to_cpp_char_array $@
cmd__home_dsw________node_deps_v8_src_inspector_inspector_gyp_inspector_injected_script_target_convert_js_to_cpp_char_array = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/src/inspector; mkdir -p $(obj)/gen/src/inspector; python build/xxd.py InjectedScriptSource_js injected-script-source.js "$(obj)/gen/src/inspector/injected-script-source.h"
...
$(obj)/gen/src/inspector/injected-script-source.h: $(srcdir)/deps/v8/src/inspector/build/xxd.py $(srcdir)/deps/v8/src/inspector/injected-script-source.js FORCE_DO_CMD
	$(call do_cmd,_home_dsw________node_deps_v8_src_inspector_inspector_gyp_inspector_injected_script_target_convert_js_to_cpp_char_array)

all_deps += $(obj)/gen/src/inspector/injected-script-source.h
action__home_dsw________node_deps_v8_src_inspector_inspector_gyp_inspector_injected_script_target_convert_js_to_cpp_char_array_outputs := $(obj)/gen/src/inspector/injected-script-source.h


### Rules for final target.
# Build our special outputs first.
$(obj).target/deps/v8/src/inspector/inspector_injected_script.stamp: | $(action__home_dsw________node_deps_v8_src_inspector_inspector_gyp_inspector_injected_script_target_convert_js_to_cpp_char_array_outputs)

# Preserve order dependency of special output on deps.
$(action__home_dsw________node_deps_v8_src_inspector_inspector_gyp_inspector_injected_script_target_convert_js_to_cpp_char_array_outputs): | 
